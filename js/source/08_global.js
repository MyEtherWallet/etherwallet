...
function bindElements() {
	...
	$('input[type=radio][name=typeOfKeyRadio]').change(function() {
        ...
        $('.btn-file :file').replaceWith($('.btn-file :file').clone());
...
function decryptFormData() {
	...
	fr.onload = function() {
		try {
          ...
          $("#decryptStatus").html('<p class="text-center text-success"><strong> Wallet successfully decrypted</strong></p>').fadeIn(50);
		} catch (err) {
