  ...
  <section class="row" ng-show="wallet!=null" ng-controller='digixCtrl'>
    ...
    <div class="col-sm-8">
     ...
     <div class="form-group col-xs-12">
        ...
        <input class="form-control disabled" type="text" value="0.02 ether per million gas" readonly />
      </div>
     <div class="form-group col-xs-12">
        <label>
          Data:
        ...
        <input class="form-control disabled" type="text" value="0x4e71d92d" readonly />
      </div>
      <div class="form-group col-xs-12">
