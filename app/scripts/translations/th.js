...
GAS_PRICE_Desc              : 'ราคาแก๊สคือจำนวนที่คุณจ่ายต่อหนึ่งหน่วยของจำนวนแก๊ส `ค่าธรรมเนียมของ ธุรกรรม (TX) = ราคาแก๊ส * จำนวนจำกัดแก๊ส` และจะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค ยิ่งราคาแก๊สสูง = ธุรกรรมก็จะสำเร็จเร็วขึ้น แต่ค่าธรรมเนียมก็จะแพงขึ้นเช่นกัน ค่าเริ่มต้นคือ `10 GWEI`',
GAS_LIMIT_Desc              : 'จำนวนจำกัดแก๊ส คือปริมาณของแก๊สที่จะส่งไปกับธุรกรรม (TX) ของคุณ `ค่าธรรมเนียม TX = ราคาแก๊ส * จำนวนจำกัดแก๊ส และจะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค การเพิ่มจำนวนนี้จะไม่ทำให้ TX ของคุณถูกขุดสำเร็จไวขึ้น การส่ง ETH = `10000` หากส่ง Token = ~`200000`',
...
TRANS_sendInfo              : 'ธุรกรรมโดยทั่วไปจะใช้ค่าแก๊สจำนวน 10000 แก๊ส ซึ่งมีมูลค่าเท่ากับ 0.000441 ETH เราจะใช้ค่าแก๊สที่สูงกว่าทั่วไปอีก 0.000000021 ETH เพื่อทำให้แน่ใจว่าธุกรรมถูกขุดอย่างรวดเร็ว เราไม่ได้เป็นผู้รับค่าธรรมเนียมในการทำธุรกรรม ',
...
OFFLINE_Step2_Label_4b      : 'ค่าแก๊สถูกจำกัดไว้ที่ 10000 เป็นค่าเริ่มต้น นอกเสียจากว่าคุณทำการส่ง Contract หรือข้อมูลอื่นเพิ่มเติม อาจจะต้องมีการเปลี่ยนแปลงค่านี้ และค่าแก๊สที่ไม่ได้ใช้จะถูกคืนให้คุณ ',
...
ERROR_8                     : 'กรุณาใส่ค่าจำกัดแก๊สให้ถูกต้อง  (ต้องเป็นตัวเลข ลอง 10000-4000000) ', // 8
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://www.myetherwallet.com/?gaslimit=10000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
