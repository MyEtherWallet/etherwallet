...
SUCCESS_3                   : 'Transaction was successfully broadcasted to the blockchain. **CLICK THE LINK TO ENSURE IT DID NOT FAIL DUE TO OUT OF GAS OR CONTRACT EXECUTION ERROR.** TX ID ', //'Транзакция отправлена на выполнение. TX ID ',
