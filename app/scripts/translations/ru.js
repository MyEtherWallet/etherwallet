...
ru.data = {
  ...
  x_Save:               'x_Сохранить',
  x_Cancel:             'x_Отменить',
  x_AddessDesc:         'Это можно назвать "номер вашего счёта" или "ваш открытый ключ". Вы сообщаете это людям, чтобы они могли отправлять вам эфир (ether). Картинка позволяет легко опознать ваш адрес среди других адресов.',
  x_PrivKey:            'Закрытый ключ (не зашифрован)',
  x_PrivKeyDesc:        'Это незашифрованное текстовое представление вашего закрытого ключа, для использования которой не требуется вводить пароль. Если посторонние узнают ваш закрытый ключ, они смогут распоряжаться вашим кошельком без ввода пароль. По этой причине обычно рекомендуют использовать зашифрованную версию закрытого ключа.',
  ...
  sidebar_donation:     'MyEtherWallet — это бесплатный сервис с открытым исходным кодом пекущийся о вашей безопасности и неприкосновенности частной жизни. Чем больше пожертвований мы получаем, тем больше времени мы проводим добавляя новые возможности, прислушиваясь в вашим пожеланиям, и предоставляя вам то, что вам необходимо. Мы — всего лишь два человека, пытающиеся изменить Мир. Вы поможете нам?',
