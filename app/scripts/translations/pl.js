...
en.data = {
  ...
  NAV_GenerateWallet:   'Stwórz Portfel',
  NAV_BulkGenerate:     'Stwórz Portfely',
  NAV_SendEther:        'Wyślij Ether',
  NAV_SendTokens:       'Wyślij Tokeny',
  NAV_Offline:          'Wyślij Bez Sieci',
  NAV_WithdrawDAO:      'Wypłacić DAO',
  DAO_TitleLong:        'Wypłać twoje Dao Tokeny dla ETH',
  NAV_ClaimDGD:         'Roszczeń DGD',
  DGD_TitleLong:        'Roszczeń Twoje DGD Tokeny',
  ...
  x_Password:           'Hasło',
  x_Download:           'Pobierz',
  x_Address:            'Twoj Adres',
  x_Save:               'Zapisz',
  x_Cancel:             'Anuluj',
  x_AddessDesc:         'You may know this as your "Account #" or your "Public Klucz". It is what you send people so they can send you ETH. That icon is an easy way to recognize your address.',
  x_PrivKey:            'Private Klucz (unencrypted)',
  x_PrivKeyDesc:        'This is the unencrypted text version of your private Klucz, meaning no password is necessary. If someone were to find your unencrypted private key, they could access your wallet without a password. For this reason, encrypted versions are typically recommended.',
  ...
  x_JsonDesc:           'This is the unencrypted, JSON format of your private Klucz. This means you do not need the password but anyone who finds your JSON can access your wallet & Ether without the password.',
  x_PrintShort:         'Print',
