...
pl.data = {
  ...
  ADD_Label_3:            'Twój portfel jest zaszyfowany. Podaj hasło: ',
  ...
  SENDModal_Yes:         'Tak, jestem pewny! Zatwierdź transakcję.',
  ...
  OFFLLINE_Step2_Title:   'Step 2: Wygeneruj transakcję (Komputer Offline)',
  ...
  HELP_0_Title:        '0) Jestem zielony. Co mam robić?',
  ...
  HELP_1_Desc_3:       'Wpisz silne hasło. Jeśli uważasz, że możesz je zapomnieć, zapisz je w jakimś bezpiecznym miejscu. Będziesz potrzebować tego hasła aby wysyłać transakcje.',
  ...
  HELP_2a_Desc_6:      'Pamietaj, że musisz się zabezpieczyć przed utratą kluczy i hasła z powodu zagubienia, uszkodzenia lub zniszczenia dysku twardego, nośnika USB lub kartki z zapisanymi danymi. Musisz się również liczyć z możliwościa wystąpienia katastrofy obejmujących większe obszary (pożar, powódź).',
  ...
  HELP_2b_Desc_7:      'Zapisz kopie zapasaowe w formie papierowej lub na nośniku USB w wielu fizycznie odseparowanych lokalizacjach.',
  ...
  HELP_4_Desc_3:        'Wybierz Twoj plik portfela -lub- wpisz klucz prywatny i odblokuj portfel.',
  ...
  HELP_4_Desc_7:        'Wpisz kwotę do wsyłania. Pozesz też kliknąć "Wyślij wszystkie dostępne środki" jeśli chcesz przesłać całą dostępną kwotę.',
  ...
  HELP_4_Desc_10:       'Pojawi się kilka kolejnych pól. Są to dane transakcji wygenerowane przez Twoją pzeglądarkę.',
  HELP_4_Desc_11:       'Kliknij niebieski przycisk "Wyślij Transakcję" na dole strony.',
  HELP_4_Desc_12:       'Pojawi się okienko z potwierdzeniem. Zweryfikuj czy kwota i adres, na który wysyłasz są prawidłowe. Następnie kliknij "Tak, jestem pewien! Zatwierdz Transakcję.".',
  HELP_4_Desc_13:       'Transakcja zostanie wysłana. TX ID zosanie wyświetlony. Możesz kliknąć TX ID aby zobaczyć tą transakcję w eksploratorze sieci Ethereum. ',

  HELP_4CX_Title:       '4)Jak wysłać Ether używając MyEtherWallet CX?',
  HELP_4CX_Desc_1:      'Njapierw musisz dodać portfel. Po dodaniu portfela masz 2 mozliwości do wyboru: funkcja "Szybki Transfer" z ikony Rozszerzenia Chrome lub zakładka "Wyślij Ether" ze strony "Moje Portfele".',
  HELP_4CX_Desc_2:      'Szybki Transfer:',
  HELP_4CX_Desc_3:      'Kliknij ikonę Rozszerzenia Chrome.',
  HELP_4CX_Desc_4:      'Kliknij przycisk "Szybki Transfer".',
  ...
  HELP_6_Desc_2:        'Możesz też wysłać połaczone środki ETH i ETC za pomocą standardowej transakcji do portalu Kraken lub Poloniex. Te kantory rozdzielą Twoje środki na ETH i ETC. Możesz wtedy wypłacić te środki do osobnych portfeli lub sprzedać ETC lub ETH.',
