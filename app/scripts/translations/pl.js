...
pl.data = {
  ...
  x_PrivKey:            'Klucz Prywatny (nie szyfrowany)',
  x_PrivKeyDesc:        'Nie szyfrowana, tekstowa wersja Twojego klucza prywatengo, nie wymaga hasła. Jeżeli ktoś zdobędzie nie szyfrowany klucz będzie mógł uzyskać pełen dostęp do Twojeg portfela bez podania hasła. Z tego powodu zaleca się używanie jego szyfrowanej wersji.',
  x_Keystore:           'Plik Keystore/JSON (Zalecany · Szyfrowany · Format Mist/Geth)',
  x_KeystoreDesc:       'Ten plik Keystore / JSON odpowiada formatowi stosowanemu przez Mist & Geth więc może być w prosty sposób zaimportowany w przyszłości. Jest to zalecana forma pliku do pobrania i przechowywania jako kopii zapasowej.',
  x_Json:               'Plik JSON (nie szyfrowany)',
  x_JsonDesc:           'Nie szyfrowany klucz prywatny, plik w formacie JSON. Nie wymaga podania hasła, ale każdy kto zdobędzie ten plik uzyska również pełny dostęp do Twojego portfela i zgromadzonych na nim środków.',
  x_PrintShort:         'Drukuj',
  x_Print:              'Drukuj Papierowy Portfel',
  x_PrintDesc:          'Wskazówka: Kliknij drukuj i zapisz plik PDF, nawet jeżeli nie posiadasz drukarki!',
  x_CSV:                'Plik CSV (nie szyfrowany)',
  x_TXT:                'Plik TXT (nie szyfrowany)',
  ...
  GEN_Placeholder_1:      'NIE zapomnij tego zapisać!',
  ...
  SEND_signed:           'Podpisz Transakcję',
  ...
  TRANSModal_Content_4:  '**Coinbase & ShapeShift: ** używaj tylko Transkacji Standardowych. Jeżeli wyślesz z opcją "Tylko...", będziesz musiał skontaktować się z pomocą techniczną usługodawcy w celu manualnego zatwierdzenia środków lub ich zwrotu. Możesz też użyć [narzędzia Shapeshift](https://split.shapeshift.io/)  do rodzielenia środków.',
