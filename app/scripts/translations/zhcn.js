...
SUCCESS_1                   : '有效地址 ',
SUCCESS_2                   : '钱包解密成功 ',
SUCCESS_3                   : 'Transaction was successfully broadcasted to the blockchain. **CLICK THE LINK TO ENSURE IT DID NOT FAIL DUE TO OUT OF GAS OR CONTRACT EXECUTION ERROR.** TX ID ', //'交易已提交。TX ID： ',
SUCCESS_4                   : '成功添加你的钱包： ',
SUCCESS_5                   : '选择的文件： ',
