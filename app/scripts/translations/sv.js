...
GAS_PRICE_Desc              : 'Gas priset är summan du betalar per enhet gas. `TX avgift = gas priset * gas limit` & betalas av miners för att inkludera din transaktion i sitt block. Ju högre gas pris, desto snabbare. Ett normalt värde är `20 GWEI`.',
