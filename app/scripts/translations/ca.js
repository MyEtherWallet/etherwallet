...
GAS_PRICE_Desc              : 'El preu del gas és la quantitat que pagues per unitat de gas. `TX fee = preu del gas * límit de gas` i es paga als miners per incloure la teva TX a un block. Preu de gas més elevat = transacció més ràpida, però més cara. Per defecte és `40 GWEI`.',
...
ERROR_10                        :  '(error_11) Si us plau introdueix un preu de gas vàlid. (Enter. Prova 40 GWEI / 20000000000 WEI.)  (Please enter a valid gas price. (Must be an integer. Try 40 GWEI / 20000000000 WEI.)',
