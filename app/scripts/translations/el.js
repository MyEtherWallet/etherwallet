...
HELP_Remind_Desc_3          : 'Αν δεν αποθηκεύσετε το ιδιωτικό σας κλειδί και τον κωδικό πρόσβασής σας, δεν υπάρχει τρόπος να ανακτήσετε πρόσβαση στο πορτοφόλι σας ή στα κεφάλαια που κατέχει. Πάρτε αντίγραφα ασφαλείας σε πολλαπλές φυσικές τοποθεσίες &ndash; όχι μόνο στον υπολογιστή σας! ',
