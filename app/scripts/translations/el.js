...
ADD_Warning_1               : 'Μπορείτε να προσθέσετε έναν λογαριασμό προς «παρακολούθηση» στην καρτέλα πορτοφολιών χωρίς να ανεβάσετε ιδιωτικό κλειδί. Αυτό ** δεν ** σημαίνει ότι έχετε πρόσβαση στο πορτοφόλι, ούτε ότι μπορείτε να μεταφέρετε αιθέρα από αυτό. ',
...
TRANS_data                  : 'Δεδομένα ',
TRANS_gas                   : 'Όριο gas ',
TRANS_sendInfo              : 'Μία τυπική συναλλαγή που χρησιμοποιεί 21000 gas θα κοστίσει 0,000441 ETH. Χρησιμοποιούμε για τιμή gas 0.000000021 ETH που είναι λίγο πάνω απο την ελάχιστη ώστε διασφαλίσουμε οτι θα επικυρωθεί γρήγορα. Δεν παίρνουμε προμήθεια για την συναλλαγή. ',
...
TRANSModal_Content_1        : '**ETH (τυπική συναλλαγή): ** This generates a default transaction directly from one address to another. It has a default gas of 21000. It is likely that any ETH sent via this method will be replayed onto the ETC chain. ',
