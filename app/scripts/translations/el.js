...
el.data = {
  ...
  DAO_TitleLong:        'Αναλήψτε τα Dao Tokens σας για ETH',
  ...
  x_PrivKeyDesc:        'Αυτο ειναι το μη-κωδικοποιημένο Κρυφό κλειδί σας που σημαίνει οτι δεν χρειάζεστε σηνθηματικό. Εαν κάποιος αποκτήσει προσβαση σε αυτο μπορει να χρησιμοποιήσει το πορτοφόλι σας χωρις συνθηματικο. Για αυτόν τον λογο προτείνουμε την χρήση μονο κρυπτογραφημένων κλειδιών.',
  x_Keystore:           'Keystore/JSON File (Προτεινόμενο · Κωδικοποιημένο · Mist/Geth Format)',
  x_KeystoreDesc:       'Αυτό το Keystore / JSON αρχείο έιναι ίδιου τύπου με αυτο που χρησιμοποιήται απο το Mist & Geth έτσι μπορείτε πολύ εύκολα να το μεταφέρετε στο μέλλον. Έιναι το αρχείο που προτείνουμε να κατεβάσετε και να αποθηκεύσετε στον υπολογιστή σας.',
