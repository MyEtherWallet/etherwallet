...
sl.data = {
  ...
  NAV_SendEther:        'Pošlji Ether',
  NAV_SendTokens:       'Pošlji Žetone',
  NAV_Offline:          'Pošlji Brez Povezave',
  NAV_WithdrawDAO:      'Izplačaj DAO',
  DAO_TitleLong:        'Izplačaj Tvoje DAO Žetone za ETH',
  NAV_ClaimDGD:         'Zahtevaj DGD',
  DGD_TitleLong:        'Zahtevaj Svoje DGD Žetone',
  ...
  x_Keystore:           'Shramba ključa/JSON Datoteka (Priporočeno · Kriptirano · Mist/Geth Format)',
  x_KeystoreDesc:       'Ta shramba ključa / JSON se ujema s formatom datoteke, ki jo uporabljata programa Mist in Geth, kar pomeni da ga lahko v prihodnosti enostavno izvozite iz te internetne strani in uvozite v Mist ali Geth. Priporočamo vam da to datoteko prenesete na vaš računalnik in jo shranite na varnem mestu. Za dodatno varnost priporočamo, da datoteko shranite na večih napravah.',
  x_Json:               'JSON Datoteka (nekriptirana)',
  x_JsonDesc:           'To je nekriptirana, JSON format verzija vašega osebnega ključa. To pomeni, da za uporabo ne potrebujete gesla. V primeru da kdorkoli najde datoteko vašega ključa, dobi takojšen dostop do vaše denarnice in vašega Ethra brez uporabe gesla.',
