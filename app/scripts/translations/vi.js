...
vi.data = {
  ...
  HELP_Warning:       'Nếu bạn đã khởi tạo Ví -hoặc- đã tải về máy tập tin có chứa dữ liệu ví trước **Ngày 31 Tháng 12 năm 2015**, xin vui lòng kiểm tra lại dữ liệu Ví; dễ tải về phiên bản mới của tập tin Ví. Chi tiết xem tại.',
  ...
  HELP_2b_Desc_8:      'đi đến trang "Xem thông tin Ví" và gõ vào Private key của bạn / mật khẩu nhằm đảm bảo rằng nó hoàn toàn chính xác và truy cập vào Ví. Kiểm tra lại mật khẩu mà bạn ghi lại trên giấy có giống nhau hay chưa.',

  HELP_3_Title:         '3) Làm thế nào dễ xác minh và truy cập vào Ví mới được khởi tạo?',
  HELP_3_Desc_1:        '**Trước khi bạn gửi số lượng Ether vô Ví mới của bạn**, bạn nen chắc chắn rằng bạn đã truy cập vào Ví thành công.',
  ...
  HELP_4CX_Title:       '4) Làm thể nào dễ gửi đi Ether bằng cách sử dụng MyEtherWallet CX?',
  HELP_4CX_Desc_1:      'Trước tiên, bạn cần phải thêm Ví của bạn vào. Sau khi thực hiện xong, Bạ sẽ có 2 lựa chọn: Chức năng "Gửi Nhanh" từ biểu tượng nằm trên thanh công cụ tiện ích của Google Chrome hoặc chọn vào "Gửi Ether" dễ đi đến trang trình duyệt.',
  ...
  HELP_4CX_Desc_6:      'Diền địa chỉ mà bạn muốn gửi đến tại khung trống "Địa chỉ đến:".',
  ...
  HELP_5_Desc_3:        'Chọn vào phần "Download Zip" nằm trên tay phảicủa bạn.',
  ...
  HELP_5CX_Desc_2:      'Di chuyển chuột đến cuối trang và nhấp chuột phải trên phien bản mới nhất. chọn vào ô "Save link as".',
  ...
  HELP_5CX_Desc_5:      'Kiểm tra lại nút "Developer Mode" nằm trên cùng của trang.',
  ...
  HELP_6_Desc_1:        'Khi Hard fork diễn ra, số ETH mà bạn đang chứa trong ví thì bây giờ bạn sẽ có số lượng ETC tương ứng. Nếu bạn gửi ETH đi bằng giao dịch thuông thường, thì nó đồng thời sẽ chuyển đi một số lượng ETC bằng với số ETH mà bạn lập giao dịch. dễ ngăn chặn điều này, bạn nên "Tách đôi" Ví hiện tại của bạn thành hai Ví riêng biệt. Tiếp tục bạn sẽ di chuyển số ETH vào đúng Ví ETH của bạn và số ETC vào trong ví ETC.',
  ...
  HELP_6_Desc_9:        'Để kiểm tra giao dịch với chỉ 0.1234 ETH hãy đi đến trang etherscan.io. Và làm tương tự với việc kiểm tra giao dịch với chỉ 0.5678 ETC thì hãy đi đến trang gastracker.io.',
  HELP_6_Desc_10:       'Khởi tạo một giao dịch với 0.0001 ETH tại Ví ETH vừa được khởi tạo. Kiểm tra trên trang etherscan.io. Và chắc chắn số 0.0001 ETH đã được chuyển đi.',
  ...
  HELP_6_Desc_12:       'Đến trang [classicetherwallet.com](http://classicetherwallet.com/#offline-transaction) Và dán TXid của Ví ETC tại trang offline của  classicetherwallet.com sau đó nhấn nút Gửi đi. Hãy kiểm tra tại trang gastracker.io. Chắc chắn giao dịch với số 0.0002 ETC đã được chuyển đi.',
  ...
  HELP_7_Desc_0:        '[Ethplorer.io](https://ethplorer.io/) là cách tốt nhất dễ kiểm tra Token và số Token.',
  ...
  HELP_7_Desc_15:       'Giao dịch của bạn sẽ được Thực hiện. TXid sẽ hiển thị cho bạn. Bạn có thể chọn vào TXid và nhìn giấy giao dịch của bạn trên blockchain.',
  ...
  HELP_8_Desc_4:        'Ngoài ra, Khả năng xảy ra vấn đề trang MyEtherWallet bị sập là rất khó. Cũng như việc chúng tôi không lưu trữ lại bất cứ dữ liệu gì vì vậy giá trị của nó sở hửu hoàn toàn bằng không. Nếu chúng tôi buộc phải  tháo tên miền này xuống, thì toàn bộ sẽ vẩn còn, tồn tại và công khai trên trang  [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Bạn có thể tải tập tin nén của nó và chạy nó trực tiếp trên máy tính của bạn. ',
  ...
  HELP_9_Desc_1:         ' Không, Trang "gửi gia dịch đi" không offline. Nó cần kết nối internet dễ xác định được giá Gas hiện tại, nonce của tài khoản, và phát sóng dễ thực hiện các giao dịch (aka "gửi"). Tuy nhiên, nó chỉ gửi đi khi giao dịch của bạn được ký từ chính bạn. Private key của bạn hoàn toàn an toàn từ bạn. hiện nay, chúng tôi có hỗ trợ thêm chức năng "Giao dịch Offline" dễ bạn có thể đảm bảo Private key của bạn đang trong tình trạng offline/airgapped của máy tính trong bất cứ lúc nào.',
  ...
  HELP_12_Desc_5:         'Chọn Ví mà bạn muốn dùng dễ sử dụng trên Mist, chon vào biểu tượng "Xem", Điền mật khẩu của bạn, và đăng nập vào Ví của bạn. ',
  HELP_12_Desc_6:         'Tìm phần "Tải về định dạng JSON - định dạng Geth/Mist (Mã hoá)". Nhấn vào nút "Tải về máy" nằm phía dưới. Bây giờ bạn đã sở hửu định dạng Keystone.',
  ...
  HELP_12_Desc_21:        'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nen xoá tập tin `nothing_special_delete_me.txt`',
  ...
  HELP_12_Desc_24:        'Lưu tập tin lại với tên như sau `nothing_special_delete_me.txt` tại ổ đỉa `C:`',
  ...
  HELP_12_Desc_27:        'Sau khi hoàn thành việc nhập Ví trên ứng dụng, bạn nen xoá tập tin `nothing_special_delete_me.txt`',
  ...
  HELP_14_Title:          '14) Một số trang khi khởi tạo Private key thông qua việc di chuyển con trõ chuột máy tính trên màn hình. MyEtherWallet.com không làm theo cách này. Các ký tự Private key được tạo ra trên trang MyEtherWallet một cách an toàn nhất?',
  ...
  HELP_19_Desc_1:         'Tập tin chứa định dạng dành cho Ví mist nằm ở mục the file locations phía trên, nó rất dể dàng dễ mở Mist, Chọn "Accounts" hàng đầu tiên của thanh công cụ, chọn "Backup", và chọn "Accounts". Nó sẽ mở ra thư mục hiện tại đang lưu trữ tập tin định dạng Ví của bạn.',

  HELP_20_Title:          '20) Tập tin Pre-sale cho Ví của tôi nằm ở đâu?',
  HELP_20_Desc_1:         'Cho dù bạn lưu trữ nó ở đâu. ;) nó cũng đều được gửi đến email của bạn, vì vậy hãy kiểm tra email. Kiếm tập tin mang tên `"ethereum_wallet_backup.json"` và sau đó chọn tập tin này. Tập tin Ví này thường đc mã hoá bởi một mật khẩu khi bạn khởi tạo nó trong lúc bạn thanh toán trong thời gian pre-sale.',

  HELP_21_Title:          '21) có thể xảy ra trường hợp có một cá nhân nào đó sử dụng ngẩu nhiên một Private key dễ thấy được số dư tài khoản của một người khác và chuyển số Ether đó vào địa chỉ mà cá nhân dó sở hửu hay không? ',
  HELP_21_Desc_1:         'Đối với phiên bản ngắn: Đièu đó có thể xảy ra, nhưng việc chọn ngẩu nhiên dễ nhằm tìm kiếm một tài khoản chứa Ether là một việc làm mất rất nhiều thời gian và cũng có thể mất cả vài chục năm dễ đạt được mục đích đó. bởi vậy trường hợp này được coi là rất khó dễ xảy ra.',
  ...
  HELP_21_Desc_3:         'Tại đây bạn đang sở hữu private key và public key. private key có thể dùng thay thế cho public key, nhưng public key không thể dùng nhằm thay thé và dùng dễ phục hồi lại private key. Thực tế trên internet và các dữ liệu cần được bảo mật của thế giới đang sử dụng loại mật mã học này, có nghĩa nếu một cách nào đó nhằm dùng public key dễ phục hồi lại private key, Thì lượng Ether mà bạn bị đánh cắp nó không phải là vấn đề lớn so với nhiều vấn đề mang tính quan trọng rất lớn của những tổ chức tài chính và chính phủ trên toàn cầu.',
  ...
  HELP_21_Desc_5:         'Vẫn có thẻ xảy ra, theo lý thuyết thì bạn sẽ sử dụng một chuỗi gồn 64 ký tự cho đến khi bạn nhận được một kết quả đúng. Thực tế, một cá nhân thông minh có thể lập trình lên một chương trình rà kết quả đúng với Private key của bạn một cách nhanh chóng. Trường hợp này giống như "brute-forcing" hoặc "mining" private keys. Nhưng viêc làm này vẫn mất rất nhièu thời gian và rất khó. Cùng với một hệ thống Server công nghệ cao, họ có khả năng dò ngẩu nhiên 1 triệu ký tự / giây. Tuy nhiên, Việc kiểm tra ngẩu nghiên này nhằm mang lại quyền đột nhập vào tài khoản của bạn sẽ phải mất một lượng chi phí rất cao dễdễ duy trì hệ thống Server của họ - và dễ rà soát cho đến khi hoàn toàn chính xác được Private key của bạn thì có lẽ cá nhân đó đã già vì phải mất cả gần trăm năm dễ cho ra kết quả chính xác.',
  ...
  HELP_SecCX_Desc_1:      'Những thông tin dữ liệu được kho tiện ích lưu trử ở đâu?',
  ...
  HELP_Sec_Desc_4:        'Hãy kiểm tra URL -- Trang của chúng tôi được cung cấp thông qua Github và bạn có thể kiểm tra lại toàn bộ mã nguồn ở đây: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) đến các tên miền: [http://kvhnuke.github.io/etherwallet/](http://kvhnuke.github.io/etherwallet) và [https://www.myetherwallet.com](https://www.myetherwallet.com). Bạn có thể xác minh nó được lưu trữ hoàn toàn tại Github thong qua trang [viewdns.info/dnsrecord/?domain=myetherwallet.com](http://viewdns.info/dnsrecord/?domain=myetherwallet.com") - sẽ có hai hồ sơ IP duy nhất đươc sở hửu bởi Github tại kho lưu trữ những tên miền tuỳ biến .',
  ...
  HELP_Sec_Desc_6:        'Bạn hảy cho chạy thử để kiểm tra lại toàn bộ hoạt động của nó. Cách đơn giản nhất để bạn kiểm tra là nhấn chuột phải vào trang của chúng tôi vào chọn mục "inspect element". đi đến mục "Network". Khởi tạo thử một Ví. Lúc này bạn sẽ thấy được các hoạt động của hệ thống sẽ diễn ra như thế nào. Bạn sẽ thấy được dữ liệu sau: image/gif và image/png. Nó chính là mã QR đã được khởi tạo...trên máy tính của bạn. Và không có một dung lượng dữ liệu nào được chuyển ra khỏi máy của bạn.',
  HELP_Sec_Desc_7:        'Bây giờ, cẩn thận hơn, hảy đến phần "Resources" của trang. Tại đây bạn sẽ thấy rõ toàn bộ những cấu tạo khác khác nhau trong việc hình thành và xây dựng lên một trang web. Nếu bạn chọn phần Local Storage, Cookies, and Cache, bạn sẽ thấy thực ra không có gì được lưu trữ. Và hoàn toàn không có gì được sao chép. Khi Refresh trang web, bạn sẽ quay về lại tình trạng ban đầu lức vừa mới truy cập.',
  HELP_Sec_Desc_8:        'Nếu bạn cảm thấy không an tâm khi sử dụng công cụ của chúng tôi, bạn có quyền không sử dụng nó. Chúng tôi tạo ra ứng dụng này nhằm giúp người sử dụng dễ dàng tạo Ví mới và lập giao dịch mà không cần dùng đến những câu lệnh trên Terminal hoặc tải về dầy đủ các node. Một lần nữa xin nhắc lại, bạn hoàn toàn có thể ngưng sử dụng và báo lại với chúng tôi nếu bạn có một mối quan ngại nào đó, chúng tôi sẽ chịu trách nhiệm chỉnh sửa hoặc giải đáp thắc mắc từ nơi bạn một cách sớm nhất có thể. Xin Chân Thành Cảm Ơn! ',

  HELP_FAQ_Title:         'Nếu bạn vần một câu trã lời hữu ích đối với những câu hỏi thường gặp',
  HELP_Contact_Title:     'Cách tốt nhất hãy liên lạc với chúng tôi'
};
