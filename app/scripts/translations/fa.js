...
TRANS_data: 'اطلاعات ',
TRANS_gas: 'سقف سوخت ',
TRANS_sendInfo: 'هزینه یک تراکنش استاندارد با سوخت 10000 معادل با 0.000441 خواهد بود. ما از هزینه گاز 0.000000021 اتر که کمی بالاتر از هزینه متوسط است استفاده می کنیم تا مطمئن شویم که سریع استخراج می شود. ما کارمزد تراکنش نمی گیریم. ',
...
HELP_10_Desc_6: 'مقدار پیش فرض برای ""سقف سوخت"" 10000 است که یک تراکنش استاندارد را پوشش می دهد. اگر در حال ارسال سرمایه به یک قرارداد هستید و یا اطلاعات بیشتری را در تراکنش خود جای دادید، باید مقدار سقف سوخت را افزایش دهید. هر مقدار سوخت که باقی بماند به شما برگردانده می شود. ',
HELP_10_Desc_7: 'اگر می خواهید می توانید اطلاعات بیشتری اضافه کنید. اگر اطلاعات را وارد کنید باید برای سقف سوخت بیش از 10000 در نظر بگیرید. تمام اطلاعات با فرمت هگز (HEX) است. ',
