...
fr.data = {
  ...
  /* Navigation*/
  NAV_YourWallets:      'Vos Porte-Monnaie',
  NAV_AddWallet:        'Ajouter un Porte-Monnaie',
  NAV_GenerateWallet:   'Générer un Porte-Monnaie',
  NAV_BulkGenerate:     'Bulk Generate',
  NAV_SendEther:        'Envoyer de l\'Ether',
  NAV_SendTokens:       'Envoyer des Tokens',
  NAV_Offline:          'Envoyer Hors Ligne',
  NAV_WithdrawDAO:      'Retirer DAO',
  DAO_TitleLong:        'Retirer vos tokens DAO en ETH',
  NAV_ClaimDGD:         'Claim DGD',
  DGD_TitleLong:        'Claim Your DGD Tokens',
  NAV_MyWallets:        'Mes Porte-Monnaie',
  NAV_ViewWallet:       'Voir les informations du Porte-Monnaie',
  NAV_Help:             'Aide',
  NAV_Contact:          'Contact',
  ...
  x_PrivKey:            'Clé privée (non encryptée)',
  ...
  x_Print:              'Imprimer une version Papier du Porte-Monnaie',
  x_PrintDesc:          'Astuce: Appuyez sur imprimer et sauvegardez le fichier en PDF, même si vous n\'avez pas d\'imprimante!',
  ...
  sidebar_TokenBal:     'Soldes des Tokens: ',
  ...
  sidebar_donate:       'Effectuer une donation',
