...
NAV_TxStatus                : '交易狀態',
tx_Details                  : '交易細節',
tx_Summary                  : '當乙太網路流量大時(例如有ICO進行中)，您的交易可能需要等待數小時甚至數天。 此工具將讓您 "取消" 或替換等待中的交易。 ** 這通常是不被允許的。 請不要過度依賴此工具，因為這些操作只有在交易池滿載時有用. [請閱讀關於此工具的說明。](https://myetherwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',
tx_notFound                 : '查無交易',
