...
zh.data = {
  ...
  NAV_AddWallet:        'Add Wallet添加钱包',
  NAV_GenerateWallet:   'Generate Wallet生成钱包',
  NAV_BulkGenerate:     'Bulk Generate批量生成',
  NAV_SendEther:        'Send Ether发送以太币',
  NAV_SendTokens:       'Send Tokens发送代币',
  NAV_Offline:          'Send Offline离线发送',
  NAV_WithdrawDAO:      'Withdraw DAO提取DAO',
  DAO_TitleLong:        'Withdraw Your Dao Tokens For ETH兑换DAO代币为ETH',
  NAV_ClaimDGD:         'Claim DGD提取DGD',
  DGD_TitleLong:        'Claim Your DGD Tokens提取DGD代币',
  NAV_DeployContract:   'Deploy Contract部署合约',
  NAV_MyWallets:        'My Wallets我的钱包',
  NAV_ViewWallet:       'View Wallet Info查看钱包信息',
  NAV_Help:             'Help帮助',
  NAV_Contact:          'Contact联系我们',

  /* General */
  x_Address:            'Your Address你的地址',
  x_AddessDesc:         'You may know this as your "Account #" or your "Public Key".你可以把地址理解为你的“账户”或者“公钥”。 It is what you send people so they can send you ether.你将地址告诉别人，他们就可以向你发送以太币。 That icon is an easy way to recognize your address.那个图标有助于判别你的地址。',
  x_Cancel:             'Cancel拒绝',
  x_CSV:                'CSV file (unencrypted)CSV文件（未加密）',
  x_Download:           'Download下载',
  x_Json:               'JSON File (unencrypted)JSON文件（未加密）',
  ...
  x_PrintShort:         'Print打印',
  x_PrivKey:            'Private Key (unencrypted)私钥（未加密）',
  x_PrivKey2:           'Private Key私钥',
  x_PrivKeyDesc:        'This is the unencrypted text version of your private key, meaning no password is necessary.这是未加密的文本格式私钥文件，这意味发送交易不需要密码。 If someone were to find your unencrypted private key, they could access your wallet without a password.如果某个人拿到了你的未加密的私钥，他们无需密码就能够控制你的钱包。 For this reason, encrypted versions are typically recommended.处于这个考虑，我们推荐你使用加密的私钥文件。',
  x_Save:               'Save保存',
  x_TXT:                'TXT file (unencrypted)TXT文件（未加密）',
  x_Wallet:             'Wallet钱包',
  ...
  FOOTER_4:               'Disclaimer声明',

  /* Sidebar */
  sidebar_AccountInfo:  'Account Information:账户信息： ',
  sidebar_AccountAddr:  'Account Address: 账户地址：',
  sidebar_AccountBal:   'Account Balance:账户余额： ',
  sidebar_TokenBal:     'Token Balances: 代币余额：',
  sidebar_Equiv:        'Equivalent Values:价值： ',
  sidebar_TransHistory: 'Transaction History:交易历史： ',
  sidebar_DGDBal:       'DGD Crowdsale Information:DGD代币众筹信息：',
  sidebar_donation:     'MyEtherWallet is a free, open-source service dedicated to your privacy and security.MyEtherWallet是保护你的隐私和安全的免费、开源服务。 The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want.我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多。 We are just two people trying to change the world. Help us?'我们只是两个尝试改变世界的两个开发者。您能帮助我们吗？,
  sidebar_donate:       'Donate捐赠',
  sidebar_thanks:       'THANK YOU!!!感谢你！！！',

  /* Decrypt Panel */
  decrypt_Access:         'How would you like to access your wallet?',
  decrypt_Title:          'Select the format of your private key:选择你的私钥文件格式：',
  decrypt_Select:         'Select a Wallet:选择一个钱包：',

  /* Add Wallet */
  ADD_Label_1:            'What would you like to do?你想执行什么操作？',
  ADD_Radio_1:            'Generate New Wallet生成新钱包',
  ADD_Radio_2:            'Select Your Wallet File (Keystore / JSON)选择你的钱包文件（Keystore/JSON）',
  ADD_Radio_2_alt:        'Select Your Wallet File: 选择你的钱包文件：',
  ADD_Radio_2_short:      'SELECT WALLET FILE...选择钱包文件',
  ADD_Radio_2_success:    'File Selected: 选择的文件：',
  ADD_Radio_3:            'Paste/Type Your Private Key ',
  ADD_Radio_4:            'Add an Account to Watch添加一个查看账户',
  ADD_Label_2:            'Create a Nickname:生成一个钱包昵称：',
  ADD_Label_3:            'Your wallet is encrypted. Please enter the password: 你的钱包被加密，请输入密码：',
  ADD_Label_4:            'Add an Account to Watch添加一个查看账户',
  ...
  ADD_Label_5:            'Enter the Address: 输入地址：',
  ADD_Label_6:            'Unlock your Wallet: 解锁钱包',
  ADD_Label_6_short:      'Unlock解锁',
  ...
  SEND_custom:           'Custom',
  SEND_gas:              'Gas Gas',
  SEND_TransferTotal:    'Send Entire Balance发送所有余额',
  SEND_generate:         'Generate Transaction生成交易',
  SEND_raw:              'Raw Transaction未生效交易',
  SEND_signed:           'Signed Transaction签名交易',
  ...
  TOKEN_Symbol:          'Token Symbol: 代币符号',
  ...
  DEP_generated:          'Generated Bytecode生成字节码',
  DEP_signtx:             'Sign Transaction签名交易',
  DEP_interface:          'Generated Interface生成界面',

  /* My Wallet */
  MYWAL_Nick:             'Wallet Nickname钱包昵称',
  MYWAL_Address:          'Wallet Address钱包地址',
  MYWAL_Bal:              'Balance余额',
  MYWAL_Edit:             'Edit 编辑',
  MYWAL_View:             'View查看',
  MYWAL_Remove:           'Remove移除',
  MYWAL_RemoveWal:        'Remove Wallet:移除钱包：',
  MYWAL_WatchOnly:        'Your Watch-Only Accounts 你的直客查看账户',
  MYWAL_Viewing:          'Viewing Wallet: 查看钱包：',
  MYWAL_Hide:             'Hide Wallet Info隐藏钱包信息',
  ...
  /* Error Messages */
  ERROR_1:             'Please enter valid amount.请输入有效数额。',
  ERROR_2:             'Your password must be at least 9 characters. Please ensure it is a strong password. 你的密码至少需要设置为9位。请确保密码足够强。',
  ERROR_3:              'Sorry! We don\'t recognize this type of wallet file.抱歉！我们不能识别这种类型的钱包文件。 ',
  ERROR_4:              'This is not a valid wallet file.这不是一个有效的钱包文件。 ',
  ERROR_5:              'This unit doesn\'t exists, please use the one of the following units ',
  ERROR_6:              'Invalid address. 无效地址。',
  ERROR_7:              'Invalid password.无效密码。 ',
  ERROR_8:              'Invalid amount.无效数额。 ',
  ERROR_9:              'Invalid gas limit. 无效gas上限。',
  ERROR_10:             'Invalid data value. 无效数据值。',
  ERROR_11:             'Invalid gas amount.无效gas数额。 ',
  ERROR_12:             'Invalid nonce. 无效nonce。',
  ERROR_13:             'Invalid signed transaction无效签名交易。. ',
  ERROR_14:             'A wallet with this nickname already exists.已经有一个钱包使用该昵称。 ',
  ERROR_15:             'Wallet not found. 找不到钱包。',
  ...
  ERROR_20:             'Invalid symbol无效符号',
  SUCCESS_1:            'Valid address有效地址',
  SUCCESS_2:            'Wallet successfully decrypted钱包解密成功',
  SUCCESS_3:            'Transaction submitted. TX ID: 交易提交。TX ID',
  SUCCESS_4:            'Your wallet was successfully added: 成功添加你的钱包：',
  SUCCESS_5:            'You have successfully voted. Thank you for being an active participant in The DAO.你已经成功投票。感谢你积极参与The DAO。',

  /* Geth Error Messages */
  GETH_InvalidSender:      'Invalid sender无效发送者',
  GETH_Nonce:              'Nonce too low Nonce太低',
  GETH_Cheap:              'Gas price too low for acceptance Gas价格太低，不被接受',
  GETH_Balance:            'Insufficient balance余额不足',
  GETH_NonExistentAccount: 'Account does not exist or account balance too low 账户不存在或者账户余额太低',
  GETH_InsufficientFunds:  'Insufficient funds for gas * price + value 余额不足，余额低于 gas * price + 发送数额',
  GETH_IntrinsicGas:       'Intrinsic gas too low 固有gas太低',
  GETH_GasLimit:           'Exceeds block gas limit超过区块gas上限',
  GETH_NegativeValue:      'Negative value 负值',
