...
globalFuncs.localStorage = {
        /* Not very elegant … pls hlp */
        cookieStorage: false,

        isAvailable: function() {
            // return typeof localStorage != "undefined";
            
            // console.log("isAvailable() globalFuncs.storageAvailable: " + globalFuncs.storageAvailable('localStorage'));
            if(!globalFuncs.storageAvailable('localStorage') && this.cookieStorage == false) {
                this.cookieStorage = true;
                globalFuncs.createCookieLocalStorage();
            }
...
/* Create fallback for localStorage based on cookies */
globalFuncs.createCookieLocalStorage = function() {
    // console.info("creating localStorage fallback");
    if (!globalFuncs.localStorage.isAvailable()) {
