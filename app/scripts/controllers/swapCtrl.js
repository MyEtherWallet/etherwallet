...
var swapCtrl = function ($scope, $sce, walletService) {
    ...
    $scope.updateKyberEstimate = function (isFrom) {
        try {
            ...
            console.log("$scope.swapOrder.fromVal", $scope.swapOrder.fromVal); //todo remove dev item
            console.log("$scope.swapOrder.toVal", $scope.swapOrder.toVal); //todo remove dev item
    ...
    $scope.updateFinalKyberEstimate = function (isFrom, callback) {
        try {
            $scope.kyber.getExpectedRate($scope.swapOrder.fromCoin, $scope.swapOrder.toCoin, $scope.swapOrder.fromVal, function (_rates) {
                ...
                console.log("updateFinalKyberEstimate", finalRate, _rates);
    ...
    $scope.parseKyberSignedTransaction = function (signedTx) {
        ...
        parsedKyberTx.txFee.eth = $scope.kyber.convertToTokenBase(parseInt(parsedKyberTx.txFee.wei), 'wei').toString()
