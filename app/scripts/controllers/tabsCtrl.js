...
var tabsCtrl = function($scope, globalService, $translate, $sce) {
    ...
    $scope.gasChanged = function() {
        ...
        $scope.gasPriceMsg = ethFuncs.gasAdjustment < 50 ? true : false
    }
    var setGasValues = function() {
        $scope.gas = {
            curVal: 50,
            value: globalFuncs.localStorage.getItem(gasPriceKey, null) ? parseInt(globalFuncs.localStorage.getItem(gasPriceKey)) : 50,
            max: 120,
            min: 1,
            step: 1
        }
