...
LedgerEth.prototype.provideERC20TokenInformation = function (data) {
  var self = this;
  return self.send(0xe0, 0x0a, 0x00, 0x00, data.data).then(
    () => true,
    e => {
...
LedgerEth.prototype.send = function (cla, ins, p1, p2, data, statusList) {
