<footer class="container-fluid">
  <div class="container">
    ...
    <p>
      <span translate="FOOTER_1">An open source, javascript, client-side tool for generating Ethererum Wallets & sending transactions.</span> Created by [kvhnuke](https://github.com/kvhnuke) and [tayvano](https://github.com/tayvano).
    </p>
