  ...
  <article class="block--wrap" style="max-width: 1780px; margin: auto;">
      ...
      <section class="footer--righ">
        <div class="footer--gas">
          <p style="padding:0;" class="col-xs-6">
          ...
          <p style="padding:0;" class="col-xs-6 text-right small">
            Std. TX: <strong>$ 1.04</strong>
            <br />
            ICO TX:  <strong>$150.00</strong>
          </p>
          <input type="range" ng-model="gas.value" min="{{gas.min}}" max="{{gas.max}}" steps="1" ng-change="gasChanged()"/>
          <p style="padding: 0;margin-left: -2rem;" class="small col-xs-3">Not So Fast</p>
          <p style="padding: 0;" class="small col-xs-3 text-center">Fast</p>
          <p style="padding: 0;" class="small col-xs-3">Fast AF</p>
          <p style="padding: 0;margin-left: 2rem;" class="small col-xs-3 text-right">ICOs Only!</p>
        </div>
