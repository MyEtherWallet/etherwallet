<article class="modal fade" id="kyberApproveTokens" tabindex="-1">
        ...
        <section class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h2 class="modal-title text-center">
                    ...
                    <span>You are about to authorize</span>...
                </h2>
                ...
                <table class="table text-center">
                    ...
                    <tr>
                        <td>
                            ...
                            <p>
                                <strong ng-show="rawKyberTx.sendMode=='ether'" class="send-modal__addr">
                                    {{wallet.getChecksumAddressString()}}
                                </strong>
                            </p>
                        </td>
                        <td ng-show="rawKyberTx.sendMode=='ether'" class="mono">
                            ->
                            <br />
                            <h4 class="text-danger">
                                {{rawKyberTx.value}} {{unitReadable}}
                            </h4>
                        </td>
                        <td ng-show="rawKyberTx.sendMode!=='ether'" class="mono">
                            ->
                        ...
                        <td ng-show="rawKyberTx.sendMode=='ether'">
                            <div class="addressIdenticon med" title="Address Indenticon" blockie-address="{{rawKyberTx.to}}" watch-var="tx.to"></div>
                            <p>
                                <strong ng-show="rawKyberTx.sendMode=='ether'" class="send-modal__addr">
                                    {{rawKyberTx.to}} ({{swapOrder.fromCoin}})
                                </strong>
                            </p>
            ...
            <div class="modal-footer">
                <h4 class="text-center">
                    <span translate="SENDModal_Content_1">You are about to authorize</span>
                    <strong ng-show="tx.sendMode=='ether'" class="mono">{{rawKyberTx.value}} {{unitReadable}}</strong>
                    ...
                    <strong ng-show="tx.sendMode=='ether'" class="mono">{{rawKyberTx.to}}.</strong>
