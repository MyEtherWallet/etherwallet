    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <table class="table text-center"><tbody><tr>
          <td><div id="addressIdenticon" class="med" title="Address Indenticon" blockie-address="{{sendingFrom}}" watch-var="sendingFrom"></div></td>
          <td class="mono">-><br />{{valueReadable}} {{unitReadable}}</td>
          <td><div id="addressIdenticon" class="med" title="Address Indenticon" blockie-address="{{sendingTo}}" watch-var="sendingTo"></div></td>
        </tr></tbody></table>
          <div class="modal-body larger">
            <p>
              <span translate="SENDModal_Content_1">You are about to send</span>
              <strong class="mono">{{valueReadable}} {{unitReadable}} from {{sendingFrom}} to {{sendingTo}}</strong>
            </p>
            <p>
