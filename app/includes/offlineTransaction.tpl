...
<article class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.offlineTransaction.id" ng-controller='sendOfflineTxCtrl'>
  ...
  <section class="row">
    ...
    <div class="form-group col-sm-10">
      <div class="account-help-icon">
        <img src="images/helpicon.svg" class="help-icon" />
        <p class="account-help-text" translate="OFFLINE_Step2_Label_4b">This was displayed in Step 1 on your online computer.</p>
        <label translate="OFFLINE_Step2_Label_4"> Nonce </label>
      </div>
    ...
    <div class="form-group col-sm-10">
      <div class="account-help-icon">
        <img src="images/helpicon.svg" class="help-icon" />
        <p class="account-help-text" translate="OFFLINE_Step2_Label_5b">This is optional. Data is often used when you send transactions to contracts.</p>
        <label translate="OFFLINE_Step2_Label_5"> Data </label>
      </div>
      <input class="form-control" type="text" placeholder="0x4d792045746865722057616c6c6574" id="offlineData" ng-model="tx.data" />
    </div>
    <div class="form-group col-sm-10">
      <label translate="OFFLINE_Step2_Label_6"> Enter / Upload your Private Key / JSON. </label>
