...
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header" ng-controller='tabsCtrl' >
    ...
    <div class="small announcement annoucement-warning">
      <div class="container">A Token Creation Period (ICO) may cause delays in transactions on June 20 2PM - 8PM GMT. <a href="https://www.google.com/search?q=what+time+is+it+gmt&oq=what+time+is+it+gmt" target="_blank" rel="noopener"> What time is it now? </a> <br /> If your TX is not urgent, we recommend waiting for faster &amp; cheaper TXs. You can also use a gas price of 50 GWEI, which you can adjust in the footer. Thank you for understanding. </div>
    </div>
