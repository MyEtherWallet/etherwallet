      ...
      <section class="container">
        ...
        <span class="dropdown">
          ...
          <ul class="dropdown-menu" ng-show="dropdownNode">
            <li><a ng-class="{true:'active'}[curNode=='eth_mew']"     ng-click="changeNode( 'eth_mew' )">    {{node.eth_mew.name}}     <small> ({{node.eth_mew.service}})     </small></a></li>
            <li><a ng-class="{true:'active'}[curNode=='eth_mew']"     ng-click="changeNode( 'etc_mew' )">    {{node.etc_mew.name}}     <small> ({{node.etc_mew.service}})     </small></a></li>
            <li><a ng-class="{true:'active'}[curNode=='tst_mew']"     ng-click="changeNode( 'tst_mew' )">    {{node.tst_mew.name}}     <small> ({{node.tst_mew.service}})     </small></a></li>
            <li><a ng-class="{true:'active'}[curNode=='eth_ethscan']" ng-click="changeNode( 'eth_ethscan' )">{{node.eth_ethscan.name}} <small> ({{node.eth_ethscan.service}}) </small></a></li>
            <li><a ng-class="{true:'active'}[curNode=='custom']"      ng-click="changeNode( 'custom' )">     {{node.custom.name}}      <small> ({{node.custom.service}})      </small></a></li>
          </ul>
        </span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row">
          <div class="form-group col-xs-12">
            ...
            <input class="form-control" type="text" placeholder="" ng-model="customNode.name">
          </div>
          <div class="form-group col-xs-9">
            <label>URL</label>
            <input class="form-control" type="text" placeholder="" ng-model="customNode.url">
          </div>
          <div class="form-group col-xs-3">
            <label>Port</label>
            <input class="form-control" type="text" placeholder="" ng-model="customNode.port">
          </div>
          <div class="form-group col-xs-12">
            <label>Options</label>
            <span class="radio">
              ...
              <label><input name="options" type="radio" ng-model="customNode.eip155" value="true"> Custom: Supports EIP-155</label>
              <label><input name="options" type="radio" ng-model="customNode.eip155" value="false"> Custom: Does not support EIP-155</label>
            </span>
          </div>
