  ...
  <section id="generatedWallet" ng-show="showWallet">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          <label>
            Download Keystore File <small>(JSON - Mist/Geth Format - encrypted)</small>:
            <div class="account-help-icon">
              ...
              <span class="account-help-text">This Keystore / JSON file matches the format used by Mist / geth so you can easily import it into those clients in the future. It is the recommended file to download and back up.</span>
            </div>
          </label>
