    ...
    <div class="col-sm-8">
      ...
      <div class="form-group col-xs-12">
        ...
        <div class="form-group input-group">
          ...
          <div class="input-group-btn">
            ...
            <ul class="dropdown-menu dropdown-menu-right" ng-show="dropdownAmount">
              <li><a name="currencyRadio" value="0" ng-model="tx.sendMode"><span translate="TRANS_standard">ETH (Standard Transaction)</span></a></li>
              <li><a name="currencyRadio" value="1" ng-model="tx.sendMode"><span translate="TRANS_eth">Only ETH </span></a></li>
              <li><a name="currencyRadio" value="2" ng-model="tx.sendMode"><span translate="TRANS_etc">Only ETC </span></a></li>
              <li role="separator" class="divider"></li>
              <li ng-repeat="token in tokenObjs track by $index" ng-show="token.balance!=0 && token.balance!='loading' || tokenVisibility=='shown' ">
                <a name="currencyRadio" value="{{$index}}" ng-model="tokenTx.id"> {{token.getSymbol()}} </a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <a class="form-group" data-toggle="modal" data-target="#txInfoModal" ng-click="txInfoModal.open()">
          <div translate="TRANS_warning">* If you are using the "Only ETH" or "Only ETC" Functions you are sending via a contract. Some services have issues accepting these transactions. Read more.</div>
        </a>
        <div class="form-group" translate="DAO_Warning">** If you are getting an <em>insufficient balance for gas * ... </em> error, you must have a small amount of ETH in your account in order to cover the cost of gas. Add 0.01 ETH to this account and try again.</div>
