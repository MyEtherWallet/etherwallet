  ...
  <section class="row" ng-show="wallet!=null" ng-controller='sendTxCtrl'>
    ...
    <div class="col-sm-8">
      ...
      <div class="form-group col-xs-12">
        ...
        <div class="radio">
          <label><input type="radio" name="currencyRadio" value="ether" ng-model="tx.unit"/>ETH (Stardard Transaction) *</label><br />
          <label><input type="radio" name="currencyRadio" value="ether" ng-model="tx.unit"/>Only ETH **</label><br />
          <label><input type="radio" name="currencyRadio" value="ether" ng-model="tx.unit"/>Only ETC ***</label>
        </div>
