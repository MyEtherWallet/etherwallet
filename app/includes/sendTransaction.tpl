  ...
  <section class="row" ng-show="wallet!=null">
    ...
    <div class="col-sm-4">
      ...
      <section class="token-balances">
        ...
        <a class="btn btn-info btn-sm" ng-click="customTokenField = !customTokenField"> <span translate="SEND_custom"> Add Custom Token </span> </a>
        ...
        <div class="input-group">
          ...
          <div class="input-group-btn">
            <a class="btn btn-default dropdown-toggle" class="dropdown-toggle" ng-click="dropdownAmount = !dropdownAmount">
              <span translate="{{transUnitReadable}}"></span>
              {{unitReadable}}
              <span class="caret"></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-right" ng-show="dropdownAmount">
              <li><a ng-class="{true:'active'}[tx.unit=='ETH']" ng-click="changeTxUnit('ETH', 'TRANS_standard')"><span translate="TRANS_standard">ETH (Standard Transaction)</span></a></li>
              <li><a ng-class="{true:'active'}[tx.unit=='onlyETH']" ng-click="changeTxUnit('onlyETH', 'TRANS_eth')"><span translate="TRANS_eth">Only ETH </span></a></li>
              <li><a ng-class="{true:'active'}[tx.unit=='onlyETC']" ng-click="changeTxUnit('onlyETC', 'TRANS_etc')"><span translate="TRANS_etc">Only ETC </span></a></li>
              <li role="separator" class="divider"></li>

              <li ng-repeat="token in tokenObjs track by $index">
         <!-- <li ng-show="token.balance!=0 && token.balance!='loading' || token.type!=='default' || tokenVisibility=='shown'"> -->
                <a ng-class="{true:'active'}[tx.unit==token.getSymbol() ]" ng-click="changeTxUnit(token.getSymbol() , token.getSymbol() )"> {{token.getSymbol()}}  </a>
              </li>
