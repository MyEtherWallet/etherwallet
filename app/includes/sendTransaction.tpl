...
<article class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.sendTransaction.id" ng-controller='sendTxCtrl'>
  ...
  <article class="collapse-container">
    ...
    <!-- Mnemonic Modal -->
      <div class="modal fade" tabindex="-1" role="dialog" style="display:block!important">
        <div class="modal-dialog" role="document" style="top: 200px">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <table class="table table-striped table-mnemonic">
                <tr>
                  ...
                  <th> Balance </th>
                <tr>
                  <td> <input type="radio" name="addressSelect" value="0" /> </td>
                  <td> 0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8 </td>
                  <td> 1.0 ETH </td>
                </tr>
                <tr>
                  <td> <input type="radio" name="addressSelect" value="0" /> </td>
                  <td> 0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8 </td>
                  <td> <a> Show Balance </a> </td>
                </tr>
                <tr>
                  <td> <input type="radio" name="addressSelect" value="0" /> </td>
                  <td> 0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8 </td>
                ...
                <tr>
                  <td><a>« Previous Addresses</a></td>
                  <td></td>
                  <td><a>More Addresses »</a></td>
                </tr>
              </table>
            </div>
            ...
            <div class="modal-footer text-center">
              ...
              <button type="button" class="btn btn-primary" data-dismiss="modal">Access Wallet</button>
            </div>
