  ...
  <table class="table table-striped" id="tblwalletsmain">
    <thead>
      <tr>
        <th></th>
        <th></th>
        <th translate="MYWAL_Nick">Wallet Nickname</th>
        <th translate="MYWAL_Address">Wallet Address</th>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title" id="myModalLabel"><span translate="MYWAL_Edit">Edit Wallet:</span> {{viewWallet.addr}}</h3>
        </div>
  ...
  <div class="modal fade" id="viewWalletDetails" tabindex="-1" role="dialog" aria-labelledby="viewKeyLabel" ng-init="showPass=true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 class="modal-title" id="myModalLabel"><span translate="NAV_ViewWallet">View Wallet Info</span>: {{viewWallet.nick}}</h3>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="removeWallet" tabindex="-1" role="dialog" aria-labelledby="removeWalletLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 class="modal-title" id="myModalLabel"><span translate="MYWAL_RemoveWal">Remove Wallet:</span> {{viewWallet.nick}}</h3>
        </div>
        <div class="modal-body">
          <h4 translate="MYWAL_Content_1">Warning! You are about to remove your wallet.</h4>
          <p translate="MYWAL_Content_2"> Be sure you have **saved the private key/JSON file and the password** associated with this wallet before you remove it.</p>
          <p translate="MYWAL_Content_3"> If you want to use this wallet with your MyEtherWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.</p>
