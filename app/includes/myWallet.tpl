  ...
  <table class="table table-striped" id="tblwalletsmain">
    <tr ng-repeat="twallet in allWallets track by $index">
      ...
      <td class="chrome-tokens">
        <h3 class="text-success col-xs-12">{{twallet.balance }} ETH</h3>
        <div class="small col-xs-6" ng-repeat="token in twallet.tokens" ng-show="token.balance!=0 && token.balance!='loading'"><strong>{{token.getBalance() }} </strong> {{token.getSymbol()}} &nbsp;&nbsp; </div>
      </td>
