    ...
    <div ng-show="showReadWrite">
      ...
      <div class="col-md-12">
        ...
        <span class="form-group" ng-show="contract.selectedFunc!=null">
          ...
          <span class="form-group">
          <button class="btn btn-primary" ng-click="readFromContract()" ng-show="contract.functions[contract.selectedFunc.index].constant">READ</button> <!-- this opens modal -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div>
              ...
              <h4>You are about to execute a function on contract {{tx.to}}.</h4>
              <!-- Gas -->
