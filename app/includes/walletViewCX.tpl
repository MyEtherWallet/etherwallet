<!-- My Wallet Page -->
<main class="tab-pane active walletViewCXCtrl" ng-if="globalService.currentTab==globalService.tabs.walletViewCX.id" ng-controller='walletViewCXCtrl'  ng-cloak>


  <!-- Your Wallet Table -->
  <h1 translate="WALL_Your"> Your Wallets </h1>
  ...
  <section id="secWatchOnlyMain">
    <h1 translate="WALL_WatchOnlyAccounts"> Your Watch-Only Accounts </h1>
  ...
  <!-- View Wallet Section -->
  <section class="row" ng-show="wallet!=null" ng-controller='walletViewCtrl'>
    <div class="col-sm-12 text-right" style="margin: 1rem 0;" ng-show="wallet!=null">
      <a class="btn btn-warning" ng-click="resetWallet()" translate="WALL_Hide"> Hide Wallet Info </a>
    </div>
    @@include( './walletView-content.tpl', { "site": "cx" } )
  </section>
  <!-- / View Wallet Section -->
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title text-primary">
            <span translate="WALL_Edit">Edit Wallet:</span>
            {{viewWallet.addr}}
          </h3>
        </div>
        <div class="modal-body">
          <form role="form">
            <div class="form-group">
              <label for="walletName" translate="WALL_Name">Wallet Name</label>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title text-warning">
            <span translate="WALL_View">View Wallet Info</span>:
            {{viewWallet.nick}}
          </h3>
        </div>
        <div class="modal-body">
          ...
          <form role="form">
            <div class="form-group">
              <label for="walletName" translate="DECRYPT_Label_3">Your file is encrypted. Please enter the password: </label>
        ...
        <div class="modal-footer text-center">
          <button type="button" class="btn btn-default" data-dismiss="modal" translate="x_Cancel">Cancel</button>
          <button type="button" class="btn btn-warning" ng-click="decryptWallet()" translate="WALL_View"> View Wallet Info </button>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title text-danger">
            <span translate="WARN_06"> Warning! You are about to remove your wallet: </span> {{viewWallet.nick}}
          </h3>
        </div>
        <div class="modal-body">
          <p translate="WARN_07"> Be sure you have **saved the private key and/or Keystore File and the password** before you remove it.</p>
          <p translate="WARN_08"> If you want to use this wallet with your MyEtherWallet CX in the future, you will need to manually re-add.</p>
        ...
        <div class="modal-footer text-center">
          ...
          <button type="button" class="btn btn-danger" ng-click="deleteWallet()" translate="WALL_Remove">Remove</button>
        </div>
      </div>
    </div>
  </section>
