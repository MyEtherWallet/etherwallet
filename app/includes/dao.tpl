    ...
    <div class="col-sm-8">
      ...
      <section class="daoGetTokens row" ng-show="curTab=='withdrawETC'">
        ...
        <!--<h4 class="col-xs-12"> There were some irregularities occcuring. Please sit tight for now.  </h4>-->
          ...
          <div class="form-group col-xs-10">
            <label> The 'White Hat Group' has been working tirelessly to get your ETC back to you. Now is your chance to say 'Thanks!' <br /> Enter the <u> percentage you would like to donate </u> to the White Hat Group below. </label>
