          ...
          <section class="proposal-expanded col-xs-12" style="display:block;">
            <table class="table">
              <tr>
                ...
                <td class="output votes-yes">{{objProposal.yeaPer | number:2}}% <em>({{objProposal.yea}})</em></td>
              </tr>
              <tr>
                <td class="label">Votes Nay:</td>
                <td class="output votes-no">{{objProposal.nayPer | number:2}}% <em>({{objProposal.nay}})</em></td>
              </tr>
              <tr>
                ...
                <td class="output">
                  ...
                  <br />
                  {{ (objProposal.yea + objProposal.nay)*100 / token.totRaised | number:2 }}%
                  <br />
                  of
                  <br />
                  {{ objProposal.minQuroum()*100 / token.totRaised | number:2}}%
                  <br />
            ...
            <div class="form-group" ng-show="objProposal.votingDeadline > objProposal.today">
