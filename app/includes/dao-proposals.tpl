...
<div class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.daoproposals.id">
  ...
  <section class="row" style="margin-bottom: 10px;">
    ...
    <div class="proposal-filter-container col-sm-5">
      <a class="proposal-filter" ng-class="filters.open=='Yes' ? 'active' : ''" ng-click="filters.open!=='Yes' ? filters.open='Yes' : filters.open='' ">Current Proposals</a>
      <a class="proposal-filter" ng-class="filters.open=='No' ? 'active' : ''"  ng-click="filters.open!=='No' ? filters.open='No' : filters.open=''">Past Proposals</a>
    </div>
    <div class="proposal-filter-container col-sm-5">
      <a class="proposal-filter" ng-class="filters.split=='No' ? 'active' : ''" ng-click="filters.split!=='No' ? filters.split='No' : filters.split=''">Non-Split Proposals</a>
      <a class="proposal-filter" ng-class="filters.split=='Yes' ? 'active' : ''" ng-click="filters.split!=='Yes' ? filters.split='Yes' : filters.split=''">Split Proposals</a>
    </div>
  ...
  <!-- / DAO Filters -->
        ...
        <article class="proposal-item col-xs-12" ng-show="objProposal.show" ng-repeat="objProposal in AllProposals | filter:filters:comparator " > <!-- ng-if="$index >= 1" -->
