  ...
  <article class="row" ng-show="!wd">
    <section class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
      <div class="input-group">
        <input class="form-control" type="text" placeholder="myetherwallet" ng-model="objENS.name"  ng-disabled="objENS.nameReadOnly" ng-class="Validator.isValidENSName(objENS.name) ? 'is-valid' : 'is-invalid'"/>
  ...
  <article class="row" ng-show="!wd">
    ...
    <h1 class="text-center">
      <span ng-show="objENS.status==ensModes.auction">
        An auction has already been started for <strong>{{objENS.name}}.eth</strong>
      </span>
