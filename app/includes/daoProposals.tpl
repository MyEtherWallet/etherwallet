...
<div class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.daoproposals.id">
  ...
  <section class="row" style="margin-bottom: 10px;">
    ...
    <div class="proposal-filter-container col-sm-5">
      <a class="proposal-filter" ng-class="filters.isOpen=='true' ? 'active' : ''"    ng-click="filters.isOpen!=='true' ? filters.isOpen='true' : filters.isOpen='' ">Current Proposals</a>
      <a class="proposal-filter" ng-class="filters.isOpen=='false' ? 'active' : ''"   ng-click="filters.isOpen!=='false' ? filters.isOpen='false' : filters.isOpen=''">Past Proposals</a>
    </div>
    <div class="proposal-filter-container col-sm-5">
  ...
  <!-- / DAO Filters -->
          ...
          <section class="proposal-expanded col-xs-12" ng-show="objProposal.showprop">
            ...
            <table class="table">
              ...
              <tr>
                ...
                <td class="output"><span ng-class="objProposal.isOpen==true ? 'boolean-yes' : 'boolean-no'"> {{objProposal.openEnglish}} </span></td>
              </tr>
              <tr>
        ...
        <section class="no-items text-center">
          <h4> Sorry...there are no results with these filters. </h4>
